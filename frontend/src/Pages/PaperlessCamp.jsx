...
const PaperlessCamp = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-blue-50 to-indigo-50">
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-primary-500 via-blue-500 to-indigo-600 overflow-hidden">
        ...
        <div className="relative z-10 px-mobile xl:px-xlarge lg:px-large 2xl:max-w-[1440px] 2xl:mx-auto pt-16 pb-20 lg:pt-20 lg:pb-28">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm border border-white/30 text-white px-3 py-1 rounded-full text-sm font-medium mb-6">
              <div className="w-2 h-2 bg-white rounded-full"></div>
              New: EaseMyMed Camps Solution
            </div>
            <h1 className="text-display-lg lg:text-display-xl font-semibold text-white mb-6 tracking-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center mb-12">
              <button className="inline-flex items-center justify-center gap-2 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white px-5 py-3 rounded-lg font-semibold transition-colors shadow-sm border border-white/30">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                Schedule Demo
              </button>
              <button className="inline-flex items-center justify-center gap-2 bg-white/10 backdrop-blur-sm hover:bg-white/20 text-white border border-white/30 px-5 py-3 rounded-lg font-semibold transition-colors shadow-sm">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
